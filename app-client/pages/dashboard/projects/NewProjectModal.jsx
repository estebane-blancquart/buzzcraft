    ...
    try {
      ...
      if (data.success) {
        ...
        console.log(
          ...
          data.data.templates.map((t) => t.id)
        );
      } else {
        ...
        setErrors({
          templates:
            "Le serveur ne peut pas fournir les templates. Impossible de créer un projet.",
        });
        setTemplates([]);
      }
    } catch (error) {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        {errors.templates && (
          <div className="error-banner">🚨 {errors.templates}</div>
        )}
        ...
        <form onSubmit={handleSubmit} className="modal-body">
          ...
          <div className="form-field">
            ...
            {templatesLoading ? (
              ...
              <div className="error">
                ❌ Aucun template disponible. Impossible de créer un projet.
              </div>
            ) : (
              <select
            ...
            {errors.template && (
              <small className="error">{errors.template}</small>
            )}
          </div>
